...
def answer_ai_query(user_query: str, session_context=None) -> Dict[str, Any]:
    ...
    try:
        ...
        prompt = (
            ...
            "6. Be concise, professional, analytical, and clear. STRICTLY respect requests for brevity (e.g., 'give me shortly', 'briefly').\n"
            "7. Structure your answers using bullet points for readability. DO NOT output large monolithic paragraphs.\n"
            "8. When useful, synthesize insights across multiple retrieved sources.\n"
            "9. For historical or ecosystem questions, provide contextual explanation rather than one-line answers.\n"
